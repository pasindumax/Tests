...
import 'validation_configs/password_match_validation_config.dart';

class Validator {
  final CurrencyHelper currencyHelper;
  Validator({required this.currencyHelper});
  ...
  ValidationResult _isRequired(String fieldName, String value,
    ...
    if (value != '') {
      ...
      return ValidationResult(
          isValid: false, message: validationConfig.customErrorMessage);
    }
  }
